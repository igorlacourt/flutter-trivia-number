...
Future<void> init() async //This async call is because of sharedPreferences which gets values asynchronously
{
  ...
  );//Receives an abstract class and calls the function passed as parameter which is its own implementation
